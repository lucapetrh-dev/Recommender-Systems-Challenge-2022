...
class DataReader(object):
    ...
    def __init__(self, reload_from_original_data = False):
        ...
        self.DATASET_SPLIT_ROOT_FOLDER = os.path.join(os.path.dirname(__file__), '../../../Desktop', self.__DATASET_SPLIT_SUBFOLDER)
        self.DATASET_OFFLINE_ROOT_FOLDER = os.path.join(os.path.dirname(__file__), '../../../Desktop', self.__DATASET_OFFLINE_SUBFOLDER)
